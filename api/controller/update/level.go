...
func Level(c *gin.Context) {
	...
	if err != nil {
		c.JSON(500, gin.H{"error": "Erro ao verificar existência do usuário"})
	...
	if err != nil {
		c.JSON(500, gin.H{"error": "Erro ao atualizar nível do usuário"})
	...
	if err != nil {
		c.JSON(500, gin.H{"error": "Erro ao deletar nível do usuário no Redis"})
